    ...
    <div className="animate-fade-in">
      ...
      <div className="container mx-auto px-6 py-20 max-w-4xl">
        <div className="prose prose-lg text-charcoal font-sans leading-relaxed max-w-none">
          <p className="mb-8 font-bold text-navy">Ipanema Partners Privacy Policy</p>
          <p className="mb-8">
            Ipanema Partners (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by Ipanema Partners. This Privacy Policy applies to our website, www.ipanemapartners.com, and its associated subdomains (collectively, our “Service”). By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Definitions and Key Terms</h3>
          <ul className="list-disc pl-6 mb-6 space-y-4">
            ...
            <li><strong>Company:</strong> When this policy mentions “Company,” “we,” “us,” or “our,” it refers to Ipanema Partners, and is responsible for your information under this Privacy Policy.</li>
            <li><strong>Country:</strong> where Ipanema Partners or the owners/founders of Ipanema Partners have based in this case is the US.</li>
            <li><strong>Customer:</strong> refers to the company, organization, or person that signs up to use the Ipanema Partners Service to manage the relationships with your consumers or service users.</li>
            <li><strong>Device:</strong> any internet-connected device such as a phone, tablet, computer, or any other device that can be used to visit Ipanema Partners and use the services.</li>
            ...
            <li><strong>Personnel:</strong> refers to those individuals who are employed by Ipanema Partners or are under contract to perform a service on behalf of one of the parties.</li>
            ...
            <li><strong>Service:</strong> refers to the service provided by Ipanema Partners as described in the relative terms (if available) and on this platform.</li>
            ...
            <li><strong>Website:</strong> Ipanema Partners’ site, which can be accessed via this URL: www.ipanemapartners.com.</li>
            <li><strong>You:</strong> a person or entity that is registered with Ipanema Partners to use the Services.</li>
          </ul>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">What Information Do We Collect?</h3>
          <p className="mb-4">We collect information from you when you visit our service, register, place an order, subscribe to our newsletter, respond to a survey or fill out a form.</p>
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">How Do We Use The Information We Collect?</h3>
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">When do we use customer information from third parties?</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Do we share the information we collect with third parties?</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Where and when is information collected from customers and end users?</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">How Do We Use Your Email Address?</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Could my information be transferred to other countries?</h3>
          <p className="mb-4">
            We are incorporated in the US. Information collected via our website, through direct interactions with you, or from the use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries that may not have laws of general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans-border transfer and hosting of such information.
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Is the information collected through our service secure?</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Can I update or correct my information?</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Personnel</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Sale of Business</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Affiliates</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">How Long Do We Keep Your Information?</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">How Do We Protect Your Information?</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Governing Law</h3>
          <p className="mb-4">
            The laws of the US, excluding its conflicts of law rules, shall govern this Agreement and your use of our service. Your use of our service may also be subject to other local, state, national, or international laws.
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Your Consent</h3>
          <p className="mb-4">
            By using our service, registering an account, or making a purchase, you consent to this Privacy Policy.
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Links to Other Websites</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Cookies</h3>
          <p className="mb-4">
            We use “Cookies” to identify the areas of our website that you have visited. A cookie is a small piece of data stored on your computer or mobile device by your web browser. We use cookies to personalize the Content that you see on our website. Most web browsers can be set to disable the use of cookies. However, if you disable Cookies, you may not be able to access functionality on our website correctly or at all. We never place Personally Identifiable Information in Cookies.
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Kids’ Privacy</h3>
          <p className="mb-4">
            We do not address anyone under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age of 13. If you are a parent or guardian and You are aware that your child has provided us with Personal Data, please contact Us. If We become aware that we have collected Personal Data from anyone under the age of 13 without verification of parental consent, We take steps to remove that information from our servers.
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Changes To Our Privacy Policy</h3>
          <p className="mb-4">
            If we decide to change our privacy policy, we will post those changes on this page, and/or update the Privacy Policy modification date below.
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Third-Party Services</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Google Analytics</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Facebook Pixel</h3>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">CLOUDFLARE</h3>
          <p className="mb-4">
            Cloudflare is a global network designed to make everything you connect to the Internet secure, private, fast, and reliable. Cloudflare provides a range of services to improve your website’s security and performance, including DDoS protection, secure SSL certificates, and content delivery network (CDN) services. When you use our Service, Cloudflare may collect information about your activity and device for the purposes of providing and improving its services. This information is processed in accordance with Cloudflare’s Privacy Policy.
          </p>
          <p className="mb-4">
            For more information on the privacy practices of Cloudflare, please visit the Cloudflare Privacy & Security Policy web page: https://www.cloudflare.com/privacypolicy/
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Tracking Technologies</h3>
          <ul className="list-disc pl-6 mb-6 space-y-4">
            <li><strong>Cookies:</strong> We use cookies to enhance the performance and functionality of our service but are non-essential to their use. However, without these cookies, certain functionality like videos may become unavailable or you would be required to enter your login details every time you visit our service as we would not be able to remember that you had logged in previously.</li>
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Information about General Data Protection Regulation (GDPR)</h3>
          <p className="mb-4">
            We may be collecting and using information from you if you are from the European Economic Area (EEA), and in this section of our Privacy Policy, we are going to explain exactly how and why is this data collected, and how we maintain this data under protection from being replicated or used in the wrong way.
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">What is GDPR?</h3>
          <p className="mb-4">
            GDPR is an EU-wide privacy and data protection law that regulates how EU residents’ data is protected by companies and enhances the control the EU residents have, over their personal data.
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">What is personal data?</h3>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <li>Personal data should only be collected to fulfill a specific purpose and it should only be used for that purpose. Organizations must specify why they need personal data when they collect it.</li>
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Why is GDPR important?</h3>
          <p className="mb-4">
            GDPR adds some new requirements regarding how companies should protect individuals’ personal data that they collect and process. It also raises the stakes for compliance by increasing enforcement and imposing greater fines for breaches. Beyond these facts, it’s simply the right thing to do. At Ipanema Partners we strongly believe that your data privacy is very important and we already have solid security and privacy practices in place that go beyond the requirements of this new regulation.
          </p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Individual Data Subject’s Rights – Data Access, Portability, and Deletion</h3>
          <p className="mb-4">
            We are committed to helping our customers meet the data subject rights requirements of GDPR. We process or store all personal data in fully vetted, DPA-compliant vendors. We do store all conversations and personal data for up to 6 years unless your account is deleted. In this case, we dispose of all data in accordance with our Terms of Service and Privacy Policy, but we will not hold it longer than 60 days.
          </p>
          <p className="mb-4">
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">California Residents</h3>
          <p className="mb-4">
          ...
          <p className="mb-4">We do not sell the Personal Information of our users.</p>
          <p className="mb-4">For more information about these rights, please contact us.</p>

          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">California Online Privacy Protection Act (CalOPPA)</h3>
          <p className="mb-4">
          ...
          <p className="mb-4">CalOPPA users have the following rights:</p>
          <ul className="list-disc pl-6 mb-6 space-y-2">
            <li><strong>Right to Know and Access.</strong> You may submit a verifiable request for information regarding the: (1) categories of Personal Information we collect, use, or share; (2) purposes for which categories of Personal Information are collected or used by us; (3) categories of sources from which we collect Personal Information, and (4) specific pieces of Personal Information we have collected about you.</li>
            <li><strong>Right to Equal Service.</strong> We will not discriminate against you if you exercise your privacy rights.</li>
            <li><strong>Right to Delete.</strong> You may submit a verifiable request to close your account and we will delete Personal Information about you that we have collected.</li>
          ...
          <h3 className="font-serif text-2xl text-navy font-bold mt-12 mb-4">Contact Us</h3>
          <p className="mb-4">Don’t hesitate to contact us if you have any questions.</p>
          <ul className="list-disc pl-6 mb-6 space-y-2">
            <li>Via Email: <a href="mailto:info@ipanemapartners.com" className="text-navy underline hover:text-gold">info@ipanemapartners.com</a></li>
          </ul>
        </div>
      </div>
    </div>
